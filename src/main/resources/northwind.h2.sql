...
CREATE TABLE territories (
    territory_id VARCHAR(20) NOT NULL,
    territory_description VARCHAR(80) NOT NULL,
...
ALTER TABLE employeeterritories    
    ADD CONSTRAINT fk_employeeterritories1 FOREIGN KEY (employee_id) REFERENCES employees (employee_id);
ALTER TABLE employeeterritories    
    ADD CONSTRAINT fk_employeeterritories2 FOREIGN KEY (territory_id) REFERENCES territories (territory_id);

ALTER TABLE order_details
    ADD CONSTRAINT pk_order_details PRIMARY KEY (order_id, product_id);
ALTER TABLE order_details
    ADD CONSTRAINT fk_order_details1 FOREIGN KEY (order_id) REFERENCES orders (order_id);
ALTER TABLE order_details
    ADD CONSTRAINT fk_order_details2 FOREIGN KEY (product_id) REFERENCES products (product_id);

ALTER TABLE orders
    ADD CONSTRAINT pk_orders PRIMARY KEY (order_id);
ALTER TABLE orders
    ADD CONSTRAINT fk_orders1 FOREIGN KEY (customer_id) REFERENCES customers (customer_id);
ALTER TABLE orders
    ADD CONSTRAINT fk_orders2 FOREIGN KEY (employee_id) REFERENCES employees (employee_id);
ALTER TABLE orders
    ADD CONSTRAINT fk_orders3 FOREIGN KEY (ship_via) REFERENCES shippers (shipper_id);    

ALTER TABLE products
    ADD CONSTRAINT pk_products PRIMARY KEY (product_id);
ALTER TABLE products
    ADD CONSTRAINT fk_products1 FOREIGN KEY (supplier_id) REFERENCES suppliers (supplier_id);
ALTER TABLE products
    ADD CONSTRAINT fk_products2 FOREIGN KEY (category_id) REFERENCES categories (category_id);
