...
public class ProductTest {
    ...
    public static void init() {
        ...
        Category.Builder cBuilder = new Category.Builder();
        Category cat1 = cBuilder.setDescription("various fruits").build("fruits");
        Category cat2 = cBuilder.setDescription("various fruits").build("FRUITS"); // Test that it is case insensitive.
        Category cat3 = cBuilder.setDescription("various veggies").build("veggies");
    ...
    public void testToString() {
        try { System.out.println("p1: " + p1);  } catch(Exception e) { e.printStackTrace(); fail("Product.toString threw an Exception"); }
    }
