...
public class EmployeeTerritoryPkTest {
    ...
    public void testHashCode() {
        ...
        Employee e1 = builder.build("Douglas", "Frank");
        ...
        Employee e2 = builder.setTitle("Sales Representative").build("Turner", "Susan");
    ...
    public void testToString() {
        ...
        try { System.out.println("pk1: " + pk1); } catch(Exception e) {e.printStackTrace(); fail("EmployeeTerritoryPk.toString threw exception");}
    }
